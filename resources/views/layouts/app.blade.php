...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    <defs>
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" id="arrow-left" viewBox="0 0 24 24"><path fill="currentColor" d="M17 11H9.41l3.3-3.29a1 1 0 1 0-1.42-1.42l-5 5a1 1 0 0 0-.21.33a1 1 0 0 0 0 .76a1 1 0 0 0 .21.33l5 5a1 1 0 0 0 1.42 0a1 1 0 0 0 0-1.42L9.41 13H17a1 1 0 0 0 0-2Z"/></symbol>
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" id="heart-filled" viewBox="0 0 24 24"><path fill="currentColor" d="M20.16 4.61A6.27 6.27 0 0 0 12 4a6.27 6.27 0 0 0-8.16 9.48l7.45 7.45a1 1 0 0 0 1.42 0l7.45-7.45a6.27 6.27 0 0 0 0-8.87Z"/></symbol>
        ...
        <symbol id="star" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" d="M12 2.5L15.09 8.76l6.91.99-5 4.87 1.18 6.88L12 17.77 5.82 21.5 7 14.62 2 9.75l6.91-.99L12 2.5Z"/></symbol>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
    ...
    <div class="offcanvas-body">
        ...
        <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex flex-column gap-3 mb-0">
            <li class="nav-item border-dashed">
                <a href="{{ route('products.index') }}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
                    <span>{{ __('All Products') }}</span>
                </a>
            </li>
            @foreach($globalCategories as $category)
            <li class="nav-item border-dashed">
                <a href="{{ route('products.index', ['category_id' => $category->id]) }}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
        ...
        <div class="row py-3 border-bottom">
            ...
            <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
                <div class="d-flex align-items-center my-3 my-sm-0">
                    <a href="{{ route('home') }}">
                        <img src="/images/logo.svg" alt="logo" width="120" class="img-fluid">
                    </a>
                </div>
            ...
            <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-4">
                <div class="search-bar row bg-light p-2 rounded-4">
                    <div class="col-md-4 d-none d-md-block">
                        <select id="category-select" class="form-select border-0 bg-transparent" onchange="window.location.href=this.value">
                            <option value="{{ route('products.index') }}" {{ !request('category_id') ? 'selected' : '' }}>{{ __('All Categories') }}</option>
                            @foreach($globalCategories as $category)
                                <option value="{{ route('products.index', ['category_id' => $category->id]) }}" {{ request('category_id') == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-11 col-md-7">
                        <form id="search-form" class="text-center" action="{{ route('products.index') }}" method="get">
                            ...
                            @endif
                            <input type="text" name="search" value="{{ request('search') }}" class="form-control border-0 bg-transparent" placeholder="{{ __('Search for more than 20,000 products') }}">
                        </form>
                    </div>
                    <div class="col-1">
                        <button type="submit" form="search-form" class="btn btn-link text-dark border-0 p-0">
            ...
            <div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
                <ul class="d-flex justify-content-end list-unstyled m-0">
                    ...
                    <li class="position-relative">
                        <a href="#" class="p-2 mx-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasFavorites" aria-controls="offcanvasFavorites">
                            <svg width="24" height="24"><use xlink:href="#heart"></use></svg>
                            <span id="favorites-count" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="display: none; font-size: 0.65rem;">0</span>
                        </a>
                    </li>
                    <li class="position-relative">
                        <a href="#" class="p-2 mx-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                            <svg width="24" height="24"><use xlink:href="#shopping-bag"></use></svg>
                            <span id="cart-count" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="display: none; font-size: 0.65rem;">0</span>
                        </a>
                    </li>
                </ul>
            </div>
