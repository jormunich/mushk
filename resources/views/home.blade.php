...
@section('content')
    ...
    <section style="background-image: url('images/banner_new.jpg');background-repeat: no-repeat;background-size: cover;">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="section-header d-flex flex-wrap justify-content-between mb-5">
                        <h2 class="section-title">{{ __('Category') }}</h2>

                        <div class="d-flex align-items-center">
                            <a href="{{ route('products.index') }}" class="btn btn-primary me-2">{{ __('View All') }}</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            ...
                            <a href="{{ route('products.index', ['category_id' => $category->id]) }}" class="nav-link swiper-slide text-center">
                                <img src="{{ $category->getFilePath() }}" class="rounded-circle" alt="{{ $category->name }}">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="section-header d-flex flex-wrap justify-content-between my-4">
                        ...
                        <h2 class="section-title">{{ __('Most popular products') }}</h2>

                        <div class="d-flex align-items-center">
                            <a href="{{ route('products.index') }}?is_popular=1" class="btn btn-primary me-2">{{ __('View All') }}</a>
                            <div class="swiper-buttons">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="section-header d-flex justify-content-between my-4">
                        ...
                        <h2 class="section-title">{{ __('Just arrived') }}</h2>

                        <div class="d-flex align-items-center">
                            <a href="{{ route('products.index') }}?sortBy=id&sort_direction=desc" class="btn btn-primary me-2">{{ __('View All') }}</a>
                            <div class="swiper-buttons">
                                <button class="swiper-prev products-carousel-prev btn btn-primary">❮</button>
                                <button class="swiper-next products-carousel-next btn btn-primary">❯</button>
                            </div>
    ...
    <section class="py-4">
        <div class="container-lg">
            <h2 class="my-4">{{ __('People are also looking for') }}</h2>
            @foreach($categories as $category)
                <a href="{{ route('products.index') }}?category_id={{ $category->id }}" class="btn btn-warning me-2 mb-2">{{ $category->name }}</a>
            @endforeach
        </div>
    </section>
